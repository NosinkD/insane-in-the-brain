...
l_debug_x86: $(DEBUG_OBJ_x86_FILES)
	$(INCLUDES) = $(L_INCLUDES)
	$(CXX) -o $(DEBUG_BUILD_x86_DIR)/main.out $(DEBUG_L_x86_LDFLAGS) $^
...
w_debug_x86: $(DEBUG_OBJ_x86_FILES)
	$(CXX) -o $(DEBUG_BUILD_x86_DIR)/main.exe $^ $(DEBUG_W_x86_LDFLAGS)
...
clean:
	...
	rm $(DEBUG_BUILD_x86_DIR)/*exe
	rm $(DEBUG_BUILD_x86_DIR)/*out
